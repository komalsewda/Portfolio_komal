...
const Hero = () => {
  ...
  return (
    <section 
      id="hero" 
      ref={containerRef}
      className="min-h-screen flex items-center relative overflow-hidden transition-all duration-500 mt-16 px-4"
      style={{
        background: 'radial-gradient(ellipse at center, #a5f1d4 0%, #e0f7fa 50%, #a5f1d4 100%)'
      }}
    >
      ...
      <div className="container mx-auto px-0 sm:px-4 lg:px-8 relative z-10">
        {/* Responsive flex: image on top for mobile, side-by-side for desktop */}
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start pt-8">
              ...
              <button className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-emerald-500 dark:from-emerald-500 dark:to-lime-500 text-white rounded-2xl font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/25 flex items-center justify-center gap-3 overflow-hidden">
          ...
          >
            <div className="relative">
              ...
              <div className="w-64 h-64 sm:w-80 sm:h-80 relative mx-auto">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-64 h-64 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-2xl border-4 border-white dark:border-gray-800">
                    <img
                      src="/c913fd6f-193f-4ba4-9773-ba64c70c10fc.jpg"
                      alt="Komal Sewda"
                      className="w-full h-full object-cover"
              ...
              {/* Floating 3D Icons */}
              <div className="absolute -top-8 -right-8 w-12 h-12 animate-orbit-1">
                <div className="w-full h-full bg-gradient-to-br from-emerald-500 to-cyan-500 dark:from-lime-500 dark:to-emerald-500 rounded-full flex items-center justify-center shadow-lg">
                  <Laptop className="w-8 h-8 text-white" />
                </div>
              </div>
              <div className="absolute -bottom-8 -left-8 w-12 h-12 animate-orbit-2">
                <div className="w-full h-full bg-gradient-to-br from-cyan-500 to-emerald-500 dark:from-emerald-500 dark:to-lime-500 rounded-full flex items-center justify-center shadow-lg">
